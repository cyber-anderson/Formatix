...
**✅ Portable & self-containedd** — no installation, no registry changes, just a single .exe file you can run from anywhere  
...
**✅ Popular Conversions Supported** — [see all supported formats](#supported-input-formats)
